        ...
        if (navigator.share) {
            try {
                await navigator.share({
                    title: 'Cerveja Virtual',
                    text: 'Olha essa incrível simulação de bebidas!',
        ...
        <div className="relative w-full h-screen overflow-hidden bg-black select-none touch-none">
            ...
            <div className="absolute bottom-6 left-6 z-[60]">
                <AnimatePresence>
                    {isMenuOpen && (
                        <motion.div
                            ...
                            exit={{ opacity: 0, y: 20 }}
                            className="absolute bottom-20 left-0 bg-zinc-800 rounded-2xl p-2 shadow-2xl flex flex-col gap-2 min-w-[220px] border border-zinc-700"
                        >
                ...
                <motion.button
                    ...
                    className="p-4 bg-[#25D366] text-white rounded-full shadow-[0_0_20px_rgba(37,211,102,0.6)] flex items-center justify-center"
                    animate={{ 
                        scale: [1, 1.2, 1],
                        rotate: [0, -15, 15, -15, 0],
                        boxShadow: [
